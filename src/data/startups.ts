...
export const startups: readonly Startup[] = [
  ...
  },
  {
    ...
    role: 'Co-Founder & CTO',
    date: 'Jan – Jun 2025',
    description: 'Crypto trading was gatekept by quants with custom infra. I built Modern Stoic to let anyone generate, backtest, and deploy automated trading strategies — then rent them out to a community of traders who could copy-trade in real time.',
    highlights: [
      '$34M market cap within the first quarter',
      '10,000+ traders on the platform generating and sharing strategies',
      'Built the full stack solo: strategy engine, marketplace, and live dashboard',
      'Automated strategy rental system that let top traders monetize their edge',
    ],
